  ...
  return (
    <div className="home">
      <div className="columns">
        ...
        <div className="centre-column">
          ...
          <div className="subtext">
            Art by{" "}
            <a href="https://www.instagram.com/perlette.pdf/">Marin Perlette</a>
          </div>
      ...
      <div className="about-me">
        ...
        artistic portfolio that spans a wide variety of media forms, I found my
        true calling in software development in 2018. With such a varied and
        successful career behind me, I apply myself to my work beyond the
